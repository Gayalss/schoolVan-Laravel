  ...
  <div class="card-body" style="margin: 2.5px;height:auto;">
    <div class="container" id="addStudent" style="display: block">
      ...
      <!-- <div class="row"> -->
        ...
        <form style="margin:5% auto" method="post" action="{{route('manageChildren.update',$Children->id)}}"  data-parsley-validate enctype="multipart/form-data">
          {{@csrf_field()}}
          @method('PUT')
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" name="firstName" class="form-control" id="firstName" placeholder="Student's First Name" value="{{$Children->firstName}}">
            </div>
            <div class="form-group col-md-6">
              <label for="lastName">Student's Last Name</label>
              <input type="text" name="lastName" class="form-control" id="lastName" placeholder="Student's Last Name" value="{{$Children->lastName}}">
            </div>
            <div class="form-group col-md-6">
              <label for="schoolName">School</label>
              <input type="text" name="schoolName" class="form-control" id="schoolName" placeholder="School" value="{{$Children->schoolName}}">
            </div>
            <div class="form-group col-md-6">
              <label for="age">Age</label>
              <input type="number" name="age" class="form-control" id="age" placeholder="Age" value="{{$Children->age}}">
            </div>
            ...
            <div class="form-group col-md-6">
              ...
              <input type="file" class="form-control-file" id="photo" name="photo" placeholder="photo" value="{{$Children->photo}}">
            </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <select id="tripType" name="tripType" class="form-control">
                @if($Children->tripType=='Home to School')
                  <option value="Home to School" selected="">Home to School</option>
                  <option value="School to Home">School to Home</option>
                  <option value="Both Ways">Both Ways</option>
                @elseif($Children->tripType=='School to Home')
                  <option value="Home to School">Home to School</option>
                  <option value="School to Home" selected="">School to Home</option>
                  <option value="Both Ways">Both Ways</option>
                @elseif($Children->tripType=='Both Ways')
                  <option value="Home to School">Home to School</option>
                  <option value="School to Home">School to Home</option>
                  <option value="Both Ways" selected="">Both Ways</option>
                @endif
              </select>
            </div>
            <div class="form-group col-md-6">
              <label for="StudentfirstName">Search</label>
              <input type="text" name="location" class="form-control" id="location" placeholder="search" value="{{$Children->location}}">
