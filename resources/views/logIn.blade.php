...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="nav navbar-nav ml-auto">
      <li class="nav-item "><a class="nav-link" href="/UserSignUp/create">Sign Up</a></li>
      <li class="nav-item active"><a class="nav-link" href="/UserLogIn/create">Log in</a></li>
    </ul>
  </div>
</nav>
        ...
        <div class="form"  style="margin:0 auto">
          <form method="post"  action="{{ route('UserLogIn.store') }}">
           ...
           <!-- <label for="exampleFormControlSelect1">Selct Account type</label> -->
            ...
            <label>Don't you have an account?<a href="/UserSignUp/create" style="color:blue"> Sign Up here</a></label> 
        </div>
      </div>
