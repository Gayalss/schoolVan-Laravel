...
<div class="container">
  @if(session()->has('success'))
    ...
    <div class="alert alert-dismissible alert-success">
      ...
      <h4 class="alert-heading">Route!</h4>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <div class="custom-control custom-radio">
                <input type="radio" id="primarySchool" name="schoolTime" class="custom-control-input" checked="" value="10.30am">
                <label class="custom-control-label" for="primarySchool">10.30am</label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" id="secondarySchool" name="schoolTime" class="custom-control-input" value="1.30pm">
