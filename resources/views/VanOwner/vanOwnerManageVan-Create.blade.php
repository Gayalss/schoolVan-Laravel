        ...
        <form style="margin:5% auto" method="post" action="{{route('manageVan.store')}}"  data-parsley-validate enctype="multipart/form-data">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="vehicleModel" placeholder="Vehicle Model" name="vehicleModel">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="number" class="form-control" id="totalSeats" placeholder="Total Seats" name="totalSeats">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="number" class="form-control" id="manufacturedYear" placeholder="Manufactured Year" name="manufacturedYear">
            </div>
