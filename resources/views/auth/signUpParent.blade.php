...
<div class="card" style="margin: 5%"> <!-- Card Starts -->
  <div class="card-body" style="margin: 2.5px;height:auto;">
    <div class="container">
      <h3 style="text-align: center; margin:auto;"> Parent's Details</h3>
     <!--  <div class="row"> -->
        
        <form style="margin:5% auto" method="post" action="{{ route('studentParent.register.submit') }}"  data-parsley-validate>
          {{@csrf_field()}}
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" name="lastName" class="form-control" id="lastName" placeholder="Last Name" data-parsley-required data-parsley-required-message="Please enter your Last Name."data-parsley-pattern="^[a-zA-Z]+$" data-parsley-trigger="keyup">
            </div>
            <div class="form-group col-md-6">
              <label for="email">Email</label>
              <input type="email" name="email" class="form-control" id="inputEmail4" placeholder="Email" data-parsley-required data-parsley-required-message="Please enter your email Address." data-parsley-type="email" data-parsley-trigger="keyup">
            </div>
            <div class="form-group col-md-6">
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="text" name="city" class="form-control" id="city" data-parsley-required>
            </div>
